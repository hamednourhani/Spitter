...
<div id="box border" class="center">
    ...
    <div id="header" style="display:inline;">
        <div class="div-border" style="margin: 10px; overflow: hidden;">
            <h2 style="float: left">Looking at ${spitterName}'s Followers</h2>
            <ul id="headerList">
                <li>
            ...
            <ol>
                <c:forEach var="follower" items="${followerList}">
                    ...
                    <span class="spittleListText">
                        <s:url value="/spitters/profile/${follower.userName}" var="userName_url"/>
                        <div class="panel" style="border-color: #296EAB;">
                                <a href="${userName_url}"><c:out value="${follower.userName}"/></a>
                            - ${follower.fullName}
                        </div>
                    </span>
                    </li>
